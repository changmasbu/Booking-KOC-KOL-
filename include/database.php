...
class DB
{
    ...
    // Hàm lấy dữ liệu dưới dạng mảng tuần tự hoặc mảng liên kết
    public function fetch_array($sql = null, $type = 0)
    {
        if ($this->cn)
        {
            ...
            if ($query)
            {
                if ($type == 0)
                {
                    // Lấy nhiều dữ liệu gán vào mảng tuần tự
                ...
                {
                    // Lấy một hàng dữ liệu gán vào mảng liên kết
