<div class="row mt-5 mb-5">
    ...
    <div class="col-md-6">
        <div class="card shadow-sm" >
            ...
            <div class="fs-3" style="text-align: center; color:#000;"> <b>Cập nhật profile</b></div>
            ...
            <div class="card-body">
                <div id="result" class="mb-3"></div>    
                    ...
                    <div class="form-group">
                        ...
                        <?php
                        $id = $data_user['id'];
                        $sql = "SELECT * FROM tbl_kol where `key` != 'Type' and id_user = '$id'";
                        foreach($db->fetch_assoc($sql, 0) as $row){
                        ?>
                    
                        <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <button class="btn btn-secondary" id="button-addon4" style="width: 100px;" data-id="<?php echo $row['id']; ?>"> <?php echo $row['key']; ?></button>
                        </div>
                            <input type="text" class="form-control"  value="<?php echo $row['value']; ?>" aria-describedby="button-addon4" disabled >
                    ...
                    <div class="d-flex justify-content-end">
                        <a class ="btn btn-primary" href= "/kol/profile">Trở về</a>
                    </div>
            </div>
        </div>
    </div>
...
$(document).ready(function () {
    $('.edit').click(function (e) {
        ...
        console.log(id);
        $.ajax({
            url: '/pages/kol/Action.php?act=show&id=' + id,
            type: 'GET',
...
$(document).ready(function () {
            // Bắt sự kiện khi người dùng click vào button
             $('#update').click(function (e) {
                 ...
                 // Gửi request
                 $.ajax({
                    url: '/pages/kol/Action.php?act=update',
                    type: 'POST',
                    data: {
                        value,
                        'id': id_up
    ...
    $(document).ready(function () {
        ...
        if (confirm('Xác nhận xóa user này ?')) {
            ...
            $.ajax({
                url: '/pages/kol/Action.php?act=del',
                type: 'POST',
                data: {
                    'delete': true,
                    'id': id
