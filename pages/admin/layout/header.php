        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/admin/dashboard">
                ...
                <div class="sidebar-brand-text mx-3">
                    ...
                    <i class="fa-solid fa-c" style="color: #ffffff;"></i>
                    <i class="fa-solid fa-h" style="color: #ffc2c2;"></i>
                    <i class="fa-solid fa-a fa-2xl" style="color: #ffffff;"></i>
                    <i class="fa-solid fa-n fa-sm" style="color: #f9d7d7;"></i>
                    <i class="fa-solid fa-g" style="color: #ffffff;"></i>
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="/admin/money">
                    <i class="fa-solid fa-coins"></i>
                    <span>Quản lý dòng tiền</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="/admin/report">
                    <i class="fa-solid fa-flag"></i>
                    <span>Quản lý report</span></a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link" href="/admin/kol">
