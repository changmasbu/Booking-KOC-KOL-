...
include ('../brand/layout/header.php')
?>
            ...
            <h4 class='mt-5 text-center text-dark '><b>Bài viết</b></h4>
                <div class="card bg-white boder-light shadow-sm  mt-4" >
                    ...
                    <div class="card-body">
                            ...
                            <p class="card-text text-dark" id ="id_post" value ="<?php echo $post['id'];?>" hidden>id bài viết :
                            <?php echo $post['id']; ?>
                            </p>      
                    </div>
...
<?php
include ('../brand/layout/footer.php');
?>
...
$(document).ready(function () {
    ...
    $('#submit').click(function (e) {
        ...
        $.ajax({
            ...
            url: '/pages/brand/Action.php?act=comment',
            type: 'POST',
            data: {
                id_post,
                comment
