                ...
                <div class="card bg-white boder-light shadow-sm mb-4 mt-4" >
                    <div class="card-header bg-white">
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="mr-2">
                                    <img class="rounded-circle" width="40" height="45" src="https://i.pinimg.com/736x/e2/17/22/e21722b39ebe23d71aeb30301425fe24.jpg" alt="">
                                </div>
                                <div class="ml-2">
                    ...
                    <a href="/pages/brand/Comment.php?id_post=<?php echo $row['id'];?>" class="card-link" value="<?php echo $row['id']; ?>">
