        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <a class="sidebar-brand d-flex align-items-center justify-content-center" style = "color: #fff;" href="/brand/page">
                    ...
                    <!-- Topbar Navbar -->
                              <!-- <ul class="nav me-auto">
                              <li class="nav-item"><a href="/brand/page" class="nav-link link-dark px-2 active text-dark mr-4" aria-current="page"><strong>Trang chủ</strong></a></li>                    
                              <li class="nav-item"><a href="/brand/post" class="nav-link link-dark px-2 active text-dark" aria-current="page"><strong>Tạo bài</strong></a></li>                    
                              </ul> -->
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            <a class="nav-link dropdown-toggle" href="/brand/page" id="alertsDropdown" role="button"
                        ...
                        <!-- Nav Item - Messages -->
                        <li class="nav-item dropdown no-arrow mx-1">
                            <a class="nav-link dropdown-toggle" href="/brand/post" id="messagesDropdown" role="button"
                                data-toggle="" aria-haspopup="true" aria-expanded="false">
                                        ...
                                        echo'
                                            ...
                                            <li class="nav-item dropdown no-arrow">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                                    ...
                                                    <a class="dropdown-item" href="/brand/profile">
                                                    <i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i>
                                                    Profile
                                                </a>
                                                    <a class="dropdown-item" href="/brand/pay">
